            ...
            return ( <
                ...
                /Select.Option> {
                    face_sprite_imgs.map((item, index) => {
                        return ( <
                            Select.Option key = { index } value = { item.id } > { item.type_name } <
                            /Select.Option>
                        )
                    })
                ...
                div className = { styles.faceWrapper } > {
                    face_url != '' ? < img className = { styles.face } src = { face_url }
                    />:null}</div > {
                        progress_per > 0 ? < Progress size = "small"
                        className = { styles.progress } percent = { progress_per } status = "active"
                        showInfo = { false }
                        />:null} <
                        /div> <
                        /div>
                                ...
                                div className = { styles.matchs } > {
                                    matchs.map((match, index) => {
                                        ...
                                        return ( <
                                            ...
                                            type = "primary"
                                            onClick = {
                                                () => this.handleOpenMatch(match) } > 查看 < /Button> <
                                            /div> <
                                            img src = { match.url }
                                            /> <
                                            /div>
