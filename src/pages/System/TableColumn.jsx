...
import { Input, Button, Form, Popconfirm, Divider, Modal, InputNumber, Switch, message, Tag } from 'antd';
import TablePage from '../../components/PageTableNew';
import { connect } from 'umi';
import { getTableColumns, updateColumn, deleteColumn, createColumn } from '../../services/table';
...
const TableColumn = ({ data, loading }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            align: 'center',
            render: (text, record) => {
                return <a href="#" onClick={(e) => { handleCreate(e, record) }}>
    ...
    const expandedRowRender = (record, index, indent, expanded) => {
        const exp_columns = [
            ...
            {
                title: '是否固定', dataIndex: 'fixed', key: 'fixed', render: (text, record) => {
                    if (text == 1) {
