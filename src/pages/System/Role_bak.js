            ...
            <Modal
                ...
                title={
                    mode ? (
                        <span>
                            <Icon type='plus'></Icon>{' '}
                            <FormattedMessage id='system.role.modal.add' />
                        </span>
                    ) : (
                        <span>
                            <Icon type='edit'></Icon>{' '}
                            <FormattedMessage id='system.role.modal.edit' />
                        </span>
                    )
                }
                ...
                <Form>
                    ...
                    <Form.Item
                        {...formItemLayout}
                        label={formatMessage({ id: 'label.sort' })}>
                    ...
                    <Form.Item
                        {...formItemLayout}
                        label={formatMessage({ id: 'label.desc' })}>
    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                sorter: true,
                sortOrder:
                    sortedInfo.columnKey === 'sort_no' && sortedInfo.order,
                width: 100,
            },
            {
                align: 'center',
