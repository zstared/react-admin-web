    ...
    render() {
        ...
        return (
            <div className={styles.pageWrapper}>
                        ...
                        {queryItem.base.length > 0 ? (
                            <Col span={6}>
                                <FormItem>
                                    ...
                                    {queryItem.more.length > 0 ? (
                                        <a
                                            style={{ marginLeft: 8 }}
                                            onClick={this.handleExpand}>
                                            {this.state.expand ? (
                                                <span>
                                                    <FormattedMessage id='label.collapse' />{' '}
                                                    <Icon type='up' />
                                                </span>
                                            ) : (
                                                <span>
                                                    <FormattedMessage id='label.expand' />{' '}
                                                    <Icon type='down' />
                                                </span>
                                            )}
                                        </a>
                ...
                <Table
                    dataSource={isTree ? data : data.rows}
                    columns={columns}
                    rowKey={rowKey}
                ...
                {isView ? (
                    <Viewer
                        ...
                        activeIndex={images.findIndex(
                            (item) => item.id == this.state.viewId
                        )}
