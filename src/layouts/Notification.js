            ...
            <div>
                ...
                {listData.length > 0 && typeInfo.type != 'all' ? (
                    <div className={styles.clear}>
                        <FormattedMessage id='home.notification.clear' />
                        {typeInfo.name}
                    </div>
                ) : null}
            </div>
    ...
    getNoticeContent = () => {
        ...
        return (
            <Tabs className={styles.tabs}>
                <TabPane
                    tab={
                        formatMessage({ id: 'home.notification.all' }) +
                    ...
                    {this.getNoticeList(data, {
                        ...
                        emptyText: formatMessage({
                            id: 'home.notification.all.empty',
                        }),
                    })}
                </TabPane>
                <TabPane
                    tab={
                        formatMessage({ id: 'home.notification.notice' }) +
                        (noticeData.length > 0 ? `(${noticeData.length})` : ``)
                    }
                    key='notice'>
                    {this.getNoticeList(noticeData, {
                        ...
                        emptyImage:
                            'https://gw.alipayobjects.com/zos/rmsportal/wAhyIChODzsoKIOBHcBk.svg',
                        emptyText: formatMessage({
                            id: 'home.notification.notice.empty',
                        }),
                    })}
                </TabPane>
                <TabPane
                    tab={
                        formatMessage({ id: 'home.notification.event' }) +
                        (eventData.length > 0 ? `(${eventData.length})` : ``)
                    }
                    key='event'>
                    {this.getNoticeList(eventData, {
                        ...
                        emptyText: formatMessage({
                            id: 'home.notification.event.empty',
                        }),
                    })}
                </TabPane>
                <TabPane
                    tab={
                        formatMessage({ id: 'home.notification.message' }) +
